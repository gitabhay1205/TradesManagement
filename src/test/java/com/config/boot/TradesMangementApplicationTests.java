...
class TradesMangementApplicationTests {
	...
	void testTradeValidateAndStoreWhenMaturityDatePast() {
		try {
			...
			Assertions.assertEquals("T2  rejected as it has maturity date less than current Date", ie.getMessage());
		}
	}
